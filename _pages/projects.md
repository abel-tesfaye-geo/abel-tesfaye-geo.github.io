...
<div class="proj-grid">
  ...
  <div class="proj-card">
    <div class="proj-thumb-placeholder">Urban Spatial Expansion<br>& Land Cover Classification</div>
    <div class="proj-body">
      ...
      <p>Applied Google Earth Engine and a Random Forest classifier to model land cover and quantify urban spatial expansion in Bahir Dar City, from raw satellite imagery to a clean, class-labeled map centered on Lake Tana and the Blue Nile. Findings were presented at a departmental research seminar.</p>
    </div>
  </div>
